...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <section class="materials-hero">
        ...
        <div class="materials-hero-art">
          <img class="hero-stone hero-stone-a" src="assets/material-stone-amethyst.svg" alt="">
          <img class="hero-stone hero-stone-b" src="assets/material-stone-rose-quartz.svg" alt="">
          <img class="hero-stone hero-stone-c" src="assets/material-stone-moonstone.svg" alt="">
          <img class="hero-stone hero-stone-d" src="assets/material-stone-obsidian.svg" alt="">
          <img class="hero-stone hero-stone-e" src="assets/material-stone-clear-quartz.svg" alt="">
      ...
      <section class="section">
        ...
        <div class="material-browser" id="materialBrowser">
          ...
          <article class="material-card" data-keywords="紫水晶">
            <img src="assets/material-stone-amethyst.svg" alt="Amethyst gemstone">
            <div>
              <h2>Amethyst</h2>
          ...
          <article class="material-card" data-keywords="粉晶">
            <img src="assets/material-stone-rose-quartz.svg" alt="Rose Quartz gemstone">
            <div>
              <h2>Rose Quartz</h2>
          ...
          <article class="material-card" data-keywords="黑曜石">
            <img src="assets/material-stone-obsidian.svg" alt="Obsidian gemstone">
            <div>
              <h2>Obsidian</h2>
          ...
          <article class="material-card" data-keywords="月光石">
            <img src="assets/material-stone-moonstone.svg" alt="Moonstone gemstone">
            <div>
              <h2>Moonstone</h2>
          ...
          <article class="material-card" data-keywords="白水晶">
            <img src="assets/material-stone-clear-quartz.svg" alt="Clear Quartz gemstone">
            <div>
              <h2>Clear Quartz</h2>
          ...
          <article class="material-card" data-keywords="粉猫眼">
            <img src="assets/material-stone-pink-catseye.svg" alt="Pink Cat's Eye gemstone">
            <div>
          ...
          <article class="material-card" data-keywords="白猫眼">
            <img src="assets/material-stone-white-catseye.svg" alt="White Cat's Eye gemstone">
            <div>
          ...
          <article class="material-card" data-keywords="海蓝宝">
            <img src="assets/material-stone-aquamarine.svg" alt="Aquamarine gemstone">
            <div>
              <h2>Aquamarine</h2>
          ...
          <article class="material-card" data-keywords="银曜石">
            <img src="assets/material-stone-silver-obsidian.svg" alt="Silver Obsidian gemstone">
            <div>
          ...
          <article class="material-card" data-keywords="白发晶">
            <img src="assets/material-stone-white-rutilated-quartz.svg" alt="White Rutilated Quartz gemstone">
            <div>
    ...
    <footer class="site-footer"><div class="footer-main"><div class="footer-brand"><img src="assets/logo-mark.png" alt=""><div><h2>Soul Stones</h2><div class="mini">Intentional Handmade Jewelry</div></div><p>Meaningful handmade jewelry crafted with crystals, natural gemstones and symbolic charms for every chapter of your life.</p><div class="socials"><a href="#">◎</a><a href="#">in</a><a href="#">X</a><a href="#">♪</a></div></div><div class="footer-col"><h3>Shop</h3><a href="products.php">Collection Gallery</a><a href="custom-design.php">Custom Design</a><a href="products.php">New Arrivals</a><a href="products.php">Gift Ideas</a></div><div class="footer-col"><h3>Themes</h3><a href="products.php">Self Love</a><a href="products.php">Protection</a><a href="products.php">Transformation</a><a href="products.php">Explore More...</a></div><div class="footer-col"><h3>About Us</h3><a href="about.php">Our Story</a><a href="materials.php">Materials</a><a href="materials.php">Care guide</a><a href="about.php">Contact</a></div></div><div class="footer-bottom"><span>© 2026 Soul Stones. All rights reserved.</span><div class="legal"><a href="#">Privacy</a><a href="#">Terms</a></div></div></footer>
    <div class="toast"></div><script src="script.js?v=materials-compact-guide"></script>
  </body>
</html>

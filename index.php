...
<html lang="en">
  <head>
    ...
    <title>Soul Stone | Intentional Handmade Jewelry</title>
    <link rel="stylesheet" href="styles.css?v=footer-full-bleed">
  </head>
  <body>
    <header class="site-header">
      <a class="logo-link" href="index.php" aria-label="Soul Stone homepage">
        <img class="logo-mark" src="assets/logo-mark.png" alt="">
        <span class="brand-name">Soul Stone</span>
      </a>
      ...
      <div class="nav-wrap">
        <nav class="main-nav" aria-label="Primary navigation">
          ...
          <a class="cart-link" href="cart.php" aria-label="Cart"><span class="bag-icon" aria-hidden="true"></span><span class="cart-count">0</span></a>
        </nav>
        <a class="black-button" href="custom-design.php">Start Designing</a>
      </div>
    </header>
    ...
    <main>
      <section class="hero">
        <div class="hero-copy">
          <h1>Soul Stone</h1>
          <div class="tagline">Intentional Handmade Jewelry</div>
          <p>Crystals, natural stones and symbolic pieces for self-love, protection and new beginnings.</p>
          <div class="hero-actions">
            <a class="gold-button" href="custom-design.php">Start Designing <span aria-hidden="true">→</span></a>
            <a class="outline-button" href="products.php">Shopping</a>
          </div>
        </div>
      </section>
        ...
        <div class="intention-row">
          <article class="intention-item">
            <div>
              ...
              <a class="text-link" href="products.php">Explore <span>→</span></a>
            </div>
            <img src="assets/collection-bracelets.png" alt="Transformation crystal bracelet">
          </article>
          <article class="intention-item">
            <div>
            ...
            <img src="assets/collection-bracelets.png" alt="Self Love crystal bracelet">
          </article>
          <article class="intention-item">
            <div>
            ...
            <img src="assets/collection-bracelets.png" alt="Protection crystal bracelet">
          </article>
          <article class="intention-item">
            <div>
            ...
            <img src="assets/collection-bracelets.png" alt="Focus crystal bracelet">
          </article>
          <article class="intention-item">
            <div>
            ...
            <img src="assets/collection-bracelets.png" alt="New Beginning crystal bracelet">
          </article>
        </div>
      </section>
        ...
        <div class="custom-panel">
          ...
          <div class="custom-detail">
            ...
            <aside class="custom-dark">
              ...
              <a class="black-button" href="custom-design.php">Start Custom Design <span>→</span></a>
            </aside>
          </div>
        </div>
      </section>
      ...
      <section class="section" id="stone-guide">
        ...
        <div class="stone-guide-row">
          <article>
            <img class="stone-photo" src="assets/stone-moonstone.png" alt="Moonstone gemstone">
            <div>
              <h3>Moonstone</h3>
          ...
          <article>
            <img class="stone-photo" src="assets/stone-rose-quartz.png" alt="Rose quartz gemstone">
            <div>
              <h3>Rose Quartz</h3>
          ...
          <article>
            <img class="stone-photo" src="assets/stone-obsidian.png" alt="Obsidian gemstone">
            <div>
              <h3>Obsidian</h3>
          ...
          <article>
            <img class="stone-photo" src="assets/stone-amethyst.png" alt="Amethyst gemstone">
            <div>
              <h3>Amethyst</h3>
             ...
             <a href="materials.php" style="display: flex; justify-content: center; align-items: center ; margin-top: 30px; color: rgb(174, 138, 94); text-decoration: underline" > Know more  →  </a>
      </section>
    ...
    <footer class="site-footer">
      <div class="footer-main">
        <div class="footer-brand">
          ...
          <div>
            <h2>Soul Stones</h2>
            <div class="mini">Intentional Handmade Jewelry</div>
          </div>
          <p>Meaningful handmade jewelry crafted with crystals, <br> natural gemstones and symbolic charms for every chapter of your life.</p>
          <div class="socials" aria-label="Social links">
            ...
            <a href="https://www.tiktok.com/" target="_blank" rel="noopener noreferrer" aria-label="TikTok">♪</a>
          </div>
        </div>
        <div class="footer-col">
          <h3>Shop</h3>
          <a href="products.php">Collection Gallery</a>
          <a href="custom-design.php">Custom Design</a>
          <a href="products.php#new-arrivals">New Arrivals</a>
          <a href="products.php#gift-ideas">Gift Ideas</a>
        </div>
        <div class="footer-col">
          <h3>Themes</h3>
          <a href="products.php#self-love">Self Love</a>
          <a href="products.php#protection">Protection</a>
          <a href="products.php#transformation">Transformation</a>
        ...
        <div class="footer-col">
          ...
          <a href="materials.php">Materials</a>
          <a href="materials.php#care-guide">Care guide</a>
          <a href="about.php#contact">Contact</a>
        </div>
      </div>
      <div class="footer-bottom">
        <span>© 2026 Soul Stones. All rights reserved.</span>
        <div class="legal">
          <a href="#">Privacy</a>
          <a href="#">Terms</a>
        </div>
